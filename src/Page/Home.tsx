...
export class Home extends Component<any, any> {
	private static introText(): JSX.Element {
		return (
			<>
				<p className="fs-5">
					Have you too much factories? Do you want keep track about your
					productions and consumptions? Do you want know how much electricity
					you are exactly using? Or manage you imports/exports between your
					factories?
				</p>
				<p className="fs-5">
					If you answered <strong>Yes</strong> to one of these question, then{" "}
					<strong className="text-primary">Satis-Factory Manager</strong> is the
					right tool for your factory management!
				</p>
			</>
		);
	}
						...
						<div className="col-12">
							<p className="alert alert-primary">
								...
								<strong>
									...
									<a
										href="https://satisfactory-newui.jplekkerkerker.nl.cz/satisfactory-beta/#/"
					...
					<div className="row">
						<div className="col-12">
							<div className="p-5 mb-4 border border-secondary">
								<h1 className="display-5 fw-bold">Satis-Factory Manager</h1>
					...
					<div className="row">
						<div className="col-4">
							<div className="p-3 fs-6 mb-2 border border-secondary h-100">
								...
								<p>
									Write down your factories exactly as you have them build in
									game!
								</p>
								<ul>
						...
						<div className="col-4">
							<div className="p-3 mb-2 fs-6 border border-secondary h-100">
								...
								<p>See overall statistics for your whole map!</p>
								<ul>
						...
						<div className="col-4">
							<div className="p-3 mb-2 fs-6 border border-secondary h-100">
								...
								<p>
									Don't want lost track about transporting your products between
									factories?
								</p>
								<ul>
									<li>Setup import/export between factories.</li>
									<li>
										See at every factory where are you importing & exporting
									</li>
								</ul>
							</div>
						</div>
					...
					<div className="row">
						...
						<div className="col-6">
							<div className="p-3 mb-2 fs-6 border border-secondary h-100">
								...
								<p>
									It's just don't about electricity for your production
									buildings.
								</p>
								<ul>
									<li>
